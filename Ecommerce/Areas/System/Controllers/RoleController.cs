...
namespace Ecommerce.Areas.System.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public RoleController(RoleManager<IdentityRole> roleManager, EcommerceContext context)
        {
        ...
        public async Task<IActionResult> delete(string id)
        {
            ...
            if (userRoles.Any())
            {
                ...
                ModelState.AddModelError("", "Vai trò này không thể xóa vì đang được sử dụng bởi người dùng.");
